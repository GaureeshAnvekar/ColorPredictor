...
This creates the data for the color_predictor app. The columns are red, green, blue, text_color ( 1(white) or 0(black) ), Can't see(0) or Can see(1).
While creating the, each part i.e. "Can't see" and "Can see" was done individually by commenting out particular sections.
